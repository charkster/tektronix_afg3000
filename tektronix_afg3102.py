...
#        "SOURce{0}:POWer:LEVel:IMMediate:AMPLitude{1}"   : "Set/query internal noise level",
    ...
    settings_por_scpi_list = [ 'OUTPut1:POLarity NORM',
                               ...
                               'SOURce1:PM:STATe 0',
                               'SOURce1:SWEep:HTIMe 0.0E0',
                               'SOURce1:PULSe:DELay 0.0E0',
                               ...
                               'SOURce1:VOLTage:LEVel:IMMediate:OFFSet 0.0E0',
                               'SOURce1:PWM:STATe 0',
                               ...
                               'SOURce2:PM:STATe 0',
                               'SOURce2:SWEep:HTIMe 0.0E0',
                               'SOURce2:PULSe:DELay 0.0E0',
                               ...
                               'SOURce2:VOLTage:LEVel:IMMediate:OFFSet 0.0E0',
                               'SOURce2:PWM:STATe 0',
